const ms = {
  ...
  portfolio: {
    ...
    featSub: "Platform Pembelajaran KSSM Sains Komputer Gamifikasi",
    featMeta: "160 soalan kuiz · Sistem tutoring · PDF download · Admin dashboard",
    featStatus: "✅ Status: Live", featBtn: "Lawati codecikgu.com →",
